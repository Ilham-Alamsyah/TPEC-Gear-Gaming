...
<section class="blog-banner-area" id="contact">
    <div class="container h-100" style="background-image:url(assets/img/Header.jpg)">
...
<div class="container">
  <div class="d-none d-sm-block mb-5 pb-4">
    ...
    <script>
      function initMap() {
        var uluru = {lat: -6.8930036, lng: 107.6546934};
        var grayStyles = [
          {
            featureType: "all",
            stylers: [
        ...
        var map = new google.maps.Map(document.getElementById('map'), {
          center: {lat: -6.8930036, lng: 107.6546934},
          zoom: 9,
          styles: grayStyles,
          scrollwheel:  false
        });
  ...
  <div class="row">
    <div class="col-md-4 col-lg-3 mb-4 mb-md-0">
      ...
      <div class="media contact-info">
        ...
        <div class="media-body">
          <h3><a href="tel:454545654">0851 5527 5754</a></h3>
          <p>Senin - Jumat</p>
        </div>
      </div>
      <div class="media contact-info">
        ...
        <div class="media-body">
          <h3><a href="mailto:support@colorlib.com">codevein171@gmail.com</a></h3>
        </div>
      </div>
    </div>
