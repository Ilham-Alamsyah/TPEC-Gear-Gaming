...
<head>
  ...
  <title>Ilham Alamsyah - @yield('title')</title>
  ...
  <header class="header_area">
    <div class="main_menu">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
          <a class="navbar-brand logo_h" href="{{ route('home.index') }}"><img src="{{asset('assets/img/logo.png')}}" alt=""></a>
	...
	<footer class="footer">
		<div class="footer-area">
			<div class="container">
				<div class="row section_gap">
					<div class="col-lg-3 col-md-6 col-sm-6">
						<div class="single-footer-widget tp_widgets">
							...
							<p>
								Mempersiapkan produk terbaik demi kenyaman pelanggan dalam bermain game apapun.
							</p>
						</div>
					</div>
              ...
              <ul class="list">
             <li> <a href="/contact">Hubungi Kami Disini</a></li>
              </ul>
							<div class="ml-40">
        ...
        Copyright &copy;<script>document.write(new Date().getFullYear());</script> Ilham Alamsyah </i>
